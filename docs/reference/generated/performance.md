---
title: "Historical ingest performance baseline"
description: "Historical ingest performance baseline reproduced from the reviewed backend source."
---
...
Generated from [`notes/performance-baseline.md`](/docs/reference/source-baseline#local-planning-evidence) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

---
title: "24. An agent is registered by the control plane, and the gateway is told when to stop honouring it"
description: "Architecture decision record 0024 from the Seagull backend."
---
...
Generated from [`docs/decisions/0024-an-agent-is-registered-by-the-control-plane-and-refused-by-the-gateway.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0024-an-agent-is-registered-by-the-control-plane-and-refused-by-the-gateway.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

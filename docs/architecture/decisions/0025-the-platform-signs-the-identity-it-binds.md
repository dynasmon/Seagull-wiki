---
title: "25. The platform signs the identity it binds, and an agent renews with the certificate it is replacing"
description: "Architecture decision record 0025 from the Seagull backend."
---
...
Generated from [`docs/decisions/0025-the-platform-signs-the-identity-it-binds.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0025-the-platform-signs-the-identity-it-binds.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

---
title: "22. Sigma is translated and never adopted, and what it can say here is what the canonical form made comparable"
description: "Architecture decision record 0022 from the Seagull backend."
---
...
Generated from [`docs/decisions/0022-sigma-is-translated-and-never-adopted.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0022-sigma-is-translated-and-never-adopted.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

---
title: "19. A rule that counts decides on the window, once per event, and says what it counted"
description: "Architecture decision record 0019 from the Seagull backend."
---
...
Generated from [`docs/decisions/0019-a-rule-that-counts-decides-on-a-window.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0019-a-rule-that-counts-decides-on-a-window.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

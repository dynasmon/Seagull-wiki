---
title: "26. An agent sends into the tenant it was registered in, and an agent the registry never named is not admitted"
description: "Architecture decision record 0026 from the Seagull backend."
---
...
Generated from [`docs/decisions/0026-an-agent-sends-into-the-tenant-it-was-registered-in.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0026-an-agent-sends-into-the-tenant-it-was-registered-in.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

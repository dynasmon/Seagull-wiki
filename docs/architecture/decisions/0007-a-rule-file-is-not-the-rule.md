---
title: "7. A rule file is not the rule"
description: "Architecture decision record 0007 from the Seagull backend."
---
...
Generated from [`docs/decisions/0007-a-rule-file-is-not-the-rule.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0007-a-rule-file-is-not-the-rule.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

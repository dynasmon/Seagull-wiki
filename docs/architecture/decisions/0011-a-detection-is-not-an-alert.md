---
title: "11. A detection is not an alert"
description: "Architecture decision record 0011 from the Seagull backend."
---
...
Generated from [`docs/decisions/0011-a-detection-is-not-an-alert.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0011-a-detection-is-not-an-alert.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

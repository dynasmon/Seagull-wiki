---
title: "20. A sequence is a rule whose stages are ordered in event time, decided once per window that holds it"
description: "Architecture decision record 0020 from the Seagull backend."
---
...
Generated from [`docs/decisions/0020-a-sequence-is-decided-by-the-window-that-holds-it.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0020-a-sequence-is-decided-by-the-window-that-holds-it.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

---
title: "18. Detection state is a bounded window of the backbone, in event time"
description: "Architecture decision record 0018 from the Seagull backend."
---
...
Generated from [`docs/decisions/0018-detection-state-is-a-bounded-window.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0018-detection-state-is-a-bounded-window.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

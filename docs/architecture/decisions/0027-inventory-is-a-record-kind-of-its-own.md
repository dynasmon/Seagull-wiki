---
title: "27. Inventory is a record kind of its own, and what an asset currently has is what the newest full scan named"
description: "Architecture decision record 0027 from the Seagull backend."
---
...
Generated from [`docs/decisions/0027-inventory-is-a-record-kind-of-its-own.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0027-inventory-is-a-record-kind-of-its-own.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

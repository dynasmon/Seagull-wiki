---
title: "23. Detection state is owned by the partition that feeds it, and rebuilt by reading that partition back"
description: "Architecture decision record 0023 from the Seagull backend."
---
...
Generated from [`docs/decisions/0023-state-is-owned-by-the-partition-and-rebuilt-by-reading-it-back.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0023-state-is-owned-by-the-partition-and-rebuilt-by-reading-it-back.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

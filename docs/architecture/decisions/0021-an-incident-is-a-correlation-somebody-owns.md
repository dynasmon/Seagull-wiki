---
title: "21. An incident is a correlation somebody owns, and how far its order can be trusted is measured"
description: "Architecture decision record 0021 from the Seagull backend."
---
...
Generated from [`docs/decisions/0021-an-incident-is-a-correlation-somebody-owns.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0021-an-incident-is-a-correlation-somebody-owns.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

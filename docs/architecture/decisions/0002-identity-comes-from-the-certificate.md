---
title: "2. Agent identity comes from the certificate"
description: "Architecture decision record 0002 from the Seagull backend."
---
...
Generated from [`docs/decisions/0002-identity-comes-from-the-certificate.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0002-identity-comes-from-the-certificate.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

---
title: "8. A ruleset is named by what is in it"
description: "Architecture decision record 0008 from the Seagull backend."
---
...
Generated from [`docs/decisions/0008-a-ruleset-is-named-by-what-is-in-it.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0008-a-ruleset-is-named-by-what-is-in-it.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

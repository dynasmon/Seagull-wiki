---
title: "17. Noise is removed from the alert plane, never from the detection stream"
description: "Architecture decision record 0017 from the Seagull backend."
---
...
Generated from [`docs/decisions/0017-noise-is-removed-from-the-alert-and-never-from-the-detection.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0017-noise-is-removed-from-the-alert-and-never-from-the-detection.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

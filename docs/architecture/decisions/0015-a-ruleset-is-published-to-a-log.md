---
title: "15. A ruleset is published to a log, and the pointer is the only mutable thing"
description: "Architecture decision record 0015 from the Seagull backend."
---
...
Generated from [`docs/decisions/0015-a-ruleset-is-published-to-a-log.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0015-a-ruleset-is-published-to-a-log.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

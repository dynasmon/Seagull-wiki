---
title: "4. Every process starts from the same skeleton"
description: "Architecture decision record 0004 from the Seagull backend."
---
...
Generated from [`docs/decisions/0004-one-process-skeleton.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0004-one-process-skeleton.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

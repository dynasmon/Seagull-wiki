---
title: "16. An alert is a detection somebody owns"
description: "Architecture decision record 0016 from the Seagull backend."
---
...
Generated from [`docs/decisions/0016-an-alert-is-a-detection-somebody-owns.md`](https://github.com/dynasmon/Seagull-backend-v2/blob/fa3bf69023db0168832346c50bd353ca4188b87a/docs/decisions/0016-an-alert-is-a-detection-somebody-owns.md) at `fa3bf69`. Refresh the checked-in snapshot before regenerating; a normal build does not access another repository.

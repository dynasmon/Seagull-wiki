...
| `Seagull-wiki`        | Guides, evidence snapshots, generated reference, static website            | Independently installable and deployable        |

## Dependency direction

<FlowDiagram diagram={repositoryDependencies} />

The dashed lines are a maintenance workflow, not runtime or build dependencies. A cloned documentation repository builds without access to the product repositories.

...
description: 'Use the actual rule format, account for field semantics, and validate shipped detection content.'
---
...
The complete, unmodified [shipped rules reference](/docs/reference/generated/rules) preserves their cases, metadata, and limitations. Use it as the format example rather than copying an invented rule skeleton.

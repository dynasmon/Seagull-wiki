...
Documentation components remain small: EUI supplies status presentation and theme context; Docusaurus owns navigation, search, MDX, TOC, and code rendering. The docs do not pull in the legacy application's charting, graph, globe, or dashboard dependencies.

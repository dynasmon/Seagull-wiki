...
description: 'Workflows for contracts, backend features, rules, API routes, and future agent collectors.'
---
...
The V2 frontend is not scaffolded. Establish its build, API, and authentication architecture first. Do not document legacy frontend conventions as a mandatory V2 implementation. See [frontend status](/docs/frontend/architecture).

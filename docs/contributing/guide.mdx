...
State current versus planned behavior, cite precise sources, and link to the canonical explanation rather than copying it. Update the implementation matrix when a composition root gains a feature. Refresh generated references only after updating their evidence snapshots. See [documentation maintenance](/docs/development/documentation).

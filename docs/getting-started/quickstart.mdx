...
description: 'Bring up the backend development stack and verify authenticated ingestion, hunting, and inventory.'
---
...
Run all commands from a clean `Seagull-backend-v2` checkout. Existing services use TLS ports 8443 to 8446 in the development topology. See [networking](/docs/deployment/topology) for overrides.
